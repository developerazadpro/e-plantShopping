...
// PlantCard Component
const PlantCard = ({ name, image, description, cost }) => (
    <div className="plant-card">
      ...
      <p className="plant-cost">{cost}</p>
      <button className="add-to-cart-button product-button" onClick={() => handleAddToCart(name)}>
      Add to Cart
    </button>
    </div>
  );
